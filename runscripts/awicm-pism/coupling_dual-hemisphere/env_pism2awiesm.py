def prepare_environment(config):
    ...
    environment_dict = {
            ...
            #todo:double-entry:RM#"CURRENT_YEAR_pism": config["general"]["current_date"].syear,
            #todo:double-entry:RM#"EXP_ID": config["general"]["command_line_config"]["expid"],
            #todo:double-entry:RM#"OUTPUT_DIR_pism": config[config["general"]["setup_name"]]["experiment_outdata_dir"],
            #todo:double-entry:RM#"SPINUP_FILE_pism": config[config["general"]["setup_name"]]["spinup_file"],
            #todo:double-entry:RM#"CHUNK_SIZE_pism_standalone": config["model2"]["chunk_size"],
            ...
            #todo:double-entry:RM#"END_YEAR_pism": config["general"]["end_date"].syear,
